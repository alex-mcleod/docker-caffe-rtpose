...
op::ProducerType gflagsToProducerType(const std::string& imageDirectory, const std::string& videoPath, const int webcamIndex)
{
    ...
    if (!imageDirectory.empty())
        ...
        op::log("===== IS VIDEO", op::Priority::High, __LINE__, __FUNCTION__, __FILE__);
        return op::ProducerType::Video; }
    else {
        op::log("===== IS WEBCAM", op::Priority::High, __LINE__, __FUNCTION__, __FILE__);
...
std::tuple<cv::Size, cv::Size, cv::Size, std::shared_ptr<op::Producer>, op::PoseModel, op::ScaleMode, std::vector<op::HeatMapType>> gflagsToOpParameters()
{
    ...
    // producerType
    op::log("VIIIIIDDDEOEOEOOEOEOEOE", op::Priority::High, __LINE__, __FUNCTION__, __FILE__);
    op::log(FLAGS_video, op::Priority::High, __LINE__, __FUNCTION__, __FILE__);
    op::log("THAT WAS VIIIIIDDDEOEOEOOEOEOEOE", op::Priority::High, __LINE__, __FUNCTION__, __FILE__);
...
int main(int argc, char *argv[])
{
    ...
    op::log("=========== ARGV", op::Priority::High, __LINE__, __FUNCTION__, __FILE__);
    op::log(argc, op::Priority::High, __LINE__, __FUNCTION__, __FILE__);
